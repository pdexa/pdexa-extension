...
namespace gko::kernels::reference::batch_template::batch_user {
...
void apply(std::shared_ptr<const DefaultExecutor> exec,
  ...
  for (size_type batch_id = 0; batch_id < num_batch_items; batch_id++) {
    batch_single_kernels::simple_apply(batch::extract_batch_item(mat, batch_id, reference_kernel{}), batch::extract_batch_item(b, batch_id, reference_kernel{}),
                                       batch::extract_batch_item(x, batch_id, reference_kernel{}));
  }
}
